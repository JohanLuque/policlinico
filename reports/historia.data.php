<page>
    ...
    <div class="container me-5">
        <div class="row">
            <?php foreach ($datosHistoria as $datos):?>
        ...
        <div class="row text-end">
            <h4>ALERGIAS: 
                <p class="mb-3" style="text-decoration: underline ;">
                    <?php foreach ($datosAlergias as $datos1):?>
                    <?=$datos1['alergia']?>,
    ...
    <table class="table table-borde mt-3">
        <tbody>
            <tr>
                <td class="tabla"><?=$datos['examenGeneral']?></td>
            </tr>
        </tbody>
    </table>
    <?php endforeach?>
...
<page>
    ...
    <table class="table table-borde mt-3">
        ...
        <tbody>
        <?php foreach ($datosTratamiento as $datos2):?>
            <tr>
                <td class="tabla"><?=$datos2['medicamento']?></td>
                <td class="tabla"><?=$datos2['presentacion']?></td>
                <td class="tabla"><?=$datos2['cantidad']?></td>
                <td class="tabla"><?=$datos2['dosis']?></td>
                <td class="tabla"><?=$datos2['dias']?></td>
            </tr>
        <?php endforeach ?>
        </tbody>
    </table>
