<page>
    ...
    <div class="container me-5">
        <div class="row">
            <?php foreach ($datosImprimir as $datos):?>
    ...
    <table class='table table-borde mt-3 '>
        <thead>
            <tr>
                <th>Inicio</th>
                <td style="width: 93%; padding: 10px;"><?=$datos['inicio']?></td>
            </tr>
        </thead>
        <tbody>
            <tr>
                <th>Curso</th>
                <td style="width: 93%; padding: 10px;"><?=$datos['curso']?></td>
            </tr>
            <tr>
                <th>Relato</th>
                <td style="width: 93%; padding: 10px;"><?=$datos['relato']?></td>
            </tr>
        </tbody>
    <?php endforeach?>
    </table>
    ...
    <table class="table table-borde mt-3">
        <tbody>
            <tr>
                <th class="tabla"><?=$datos['examenGeneral']?></th>
            </tr>
        </tbody>
    </table>
    <?php endforeach?>
    ...
    <?php foreach ($datosImprimir as $datos):?>
    <table class="table table-borde mt">
        <colgroup>  
            <col style="width: 10%">
            <col style="width: 60%">
            <col style="width: 10%">
        ...
        <tbody>
            <tr>
                <td class="tabla"><?=$datos['codigoCie_10']?></td>
                <td class="tabla"><?=$datos['descripcion']?></td>
                <td class="tabla text-center">
                <?php if ($datos["frecuencia"] === "P"): ?>
                        x
                <?php endif; ?>
                </td>
                <td class="tabla text-center">
                <?php if ($datos["frecuencia"] === "D"): ?>
                        x
                <?php endif; ?>
                </td>
                <td class="tabla text-center">
                <?php if ($datos["frecuencia"] === "R"): ?>
                        x 
                <?php endif; ?>
                </td>
            </tr>
...
<page>
    ...
    <table class="table table-borde mt-3">
        ...
        <tbody>
            <tr>
                <td class="tabla"><?=$datos['procedimiento']?></td>
            </tr>
    ...
    <table class="table table-borde mt-3">
        ...
        <?php foreach ($datosTratamiento as $datos):?>
        <tbody>
            <tr>
                <td class="tabla"><?=$datos['medicamento']?></td>
                <td class="tabla"><?=$datos['presentacion']?></td>
                <td class="tabla"><?=$datos['cantidad']?></td>
                <td class="tabla"><?=$datos['dosis']?></td>
                <td class="tabla"><?=$datos['dias']?></td>
            </tr>
        </tbody>
        <?php endforeach?>
    </table>
    ...
    <table class="table table-borde mt-3">
        ...
        <?php foreach ($datosImprimir as $datos):?>
            <tr>
                <td class="tabla"><?=$datos['observaciones']?></td>
            </tr>
        </tbody>
        <?php endforeach?>
    </table>
